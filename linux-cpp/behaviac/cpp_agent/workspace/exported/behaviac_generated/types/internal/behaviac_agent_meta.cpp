...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(2519980494u);
			...
			// cpp_agent
			meta = BEHAVIAC_NEW AgentMeta(2358727647u);
			AgentMeta::GetAgentMetas()[995062030u] = meta;
			meta->RegisterMemberProperty(4100805676u, BEHAVIAC_NEW CMemberProperty< int >("int_val", Set_cpp_agent_int_val, Get_cpp_agent_int_val));
			meta->RegisterMethod(727732608u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_cpp_agent_HelloCppAgent));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_cpp_agent_LogMessage));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta::Register<cpp_agent>("cpp_agent");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<cpp_agent>("cpp_agent");
