...
#ifndef PROTOBUF_person_2eproto_INCLUDED
#define PROTOBUF_person_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::AddressBook* Arena::Create< ::AddressBook>(Arena*);
template<> ::Person* Arena::Create< ::Person>(Arena*);
template<> ::Person_PhoneNumber* Arena::Create< ::Person_PhoneNumber>(Arena*);
}  // namespace protobuf
}  // namespace google
...
#endif  // PROTOBUF_person_2eproto_INCLUDED
