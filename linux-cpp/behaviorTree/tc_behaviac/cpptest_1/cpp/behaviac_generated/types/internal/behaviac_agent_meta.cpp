...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(2295515739u);
			...
			// PlayerAgent
			meta = BEHAVIAC_NEW AgentMeta(3364047816u);
			AgentMeta::GetAgentMetas()[509666443u] = meta;
			meta->RegisterMethod(1377398786u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlayerAgent_autoFight));
			meta->RegisterMethod(3536900202u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlayerAgent_autoMove));
			meta->RegisterMethod(1397644290u, BEHAVIAC_NEW CAgentMethod< bool >(FunctionPointer_PlayerAgent_canFight));
			meta->RegisterMethod(3459435451u, BEHAVIAC_NEW CAgentMethod< bool >(FunctionPointer_PlayerAgent_canMove));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_PlayerAgent_LogMessage));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
